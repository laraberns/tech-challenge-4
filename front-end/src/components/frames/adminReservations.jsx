...
const FrameAdminReservations = ({ nextAction }) => {
    ...
    const getAllReservas = async () => {
        try {
            const response = await fetch(`http://localhost:8081/api/reservas/allReservas`);
    ...
    return (
        <WrapperContent text="Reservas" icon={<SportsBaseballIcon />} bgcolorAvatar='green'>
            ...
            <Button onClick={() => { dispatch({ type: 'SET_STAGE', payload: 'adminSchedule' }) }}>
...
export default FrameAdminReservations;
